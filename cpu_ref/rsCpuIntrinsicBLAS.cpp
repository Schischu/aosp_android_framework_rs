...
void RsdCpuScriptIntrinsicBLAS::invokeForEach(uint32_t slot,
    ...
    case (RsBlas_cgbmv):
        ...
        break;
    case (RsBlas_ctrmv):
        initAB(ain, sizeof(float)*2, &A, &X, &lda, &ldb);
    ...
    case (RsBlas_zgbmv):
        ...
        break;
    case (RsBlas_ztrmv):
        initAB(ain, sizeof(double)*2, &A, &X, &lda, &ldb);
    ...
    case (RsBlas_cgerc):
        ...
        break;
    case (RsBlas_cher):
        initAB(ain, sizeof(float)*2, &X, &A, &ldb, &lda);
    ...
    case (RsBlas_zgerc):
        ...
        break;
    case (RsBlas_zher):
        initAB(ain, sizeof(double)*2, &X, &A, &ldb, &lda);
    ...
    case (RsBlas_csyrk):
        // C is stored in the second Allocation for syrk
        initAB(ain, sizeof(float)*2, &A, &C, &lda, &ldc);
    ...
    case (RsBlas_csyr2k):
        ...
        break;
    case (RsBlas_ctrmm):
        initAB(ain, sizeof(float)*2, &A, &B, &lda, &ldb);
    ...
    case (RsBlas_zsyrk):
        // C is stored in the second Allocation for syrk
        initAB(ain, sizeof(double)*2, &A, &C, &lda, &ldc);
    ...
    case (RsBlas_zsyr2k):
        ...
        break;
    case (RsBlas_ztrmm):
        initAB(ain, sizeof(double)*2, &A, &B, &lda, &ldb);
