...
#undef SIGN_EXTEND
        ...
        // __android_log_print(ANDROID_LOG_INFO, "rs", "CALL26/JUMP26 relocation for symbol %p\n",
            // callee_addr);
        ...
        if (call_via_stub) {
          // __android_log_print(ANDROID_LOG_INFO, "rs", "need stub\n");
          // Get the stub for this function
          StubLayout *stub_layout = text->getStubLayout();
        ...
        // __android_log_print(ANDROID_LOG_INFO, "rs", "relocating with result %x\n", result);
