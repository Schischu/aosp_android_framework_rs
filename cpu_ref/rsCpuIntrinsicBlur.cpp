...
static void OneVU4(const RsForEachKernelStruct *p, float4 *out, int32_t x, int32_t y,
...
static void OneVU1(const RsForEachKernelStruct *p, float *out, int32_t x, int32_t y,
                   const uchar *ptrIn, int iStride, const float* gPtr, int iradius) {
...
static void OneHU4(const RsForEachKernelStruct *p, uchar4 *out, int32_t x,
...
static void OneHU1(const RsForEachKernelStruct *p, uchar *out, int32_t x,
...
void RsdCpuScriptIntrinsicBlur::kernelU4(const RsForEachKernelStruct *p,
                                         uint32_t xstart, uint32_t xend,
                                         uint32_t instep, uint32_t outstep) {
...
void RsdCpuScriptIntrinsicBlur::kernelU1(const RsForEachKernelStruct *p,
                                         uint32_t xstart, uint32_t xend,
                                         uint32_t instep, uint32_t outstep) {
    float buf[4 * 2048];
    RsdCpuScriptIntrinsicBlur *cp = (RsdCpuScriptIntrinsicBlur *)p->usr;
