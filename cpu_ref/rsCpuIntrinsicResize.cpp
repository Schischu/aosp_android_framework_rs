...
void RsdCpuScriptIntrinsicResize::kernelU4(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
...
void RsdCpuScriptIntrinsicResize::kernelU2(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicResize *cp = (RsdCpuScriptIntrinsicResize *)p->usr;
...
void RsdCpuScriptIntrinsicResize::kernelU1(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicResize *cp = (RsdCpuScriptIntrinsicResize *)p->usr;
