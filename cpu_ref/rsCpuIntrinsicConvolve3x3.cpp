...
protected:
    ...
    static void kernelU1(const RsForEachKernelStruct *p,
                         uint32_t xstart, uint32_t xend,
                         uint32_t instep, uint32_t outstep);
    static void kernelU2(const RsForEachKernelStruct *p,
                         uint32_t xstart, uint32_t xend,
                         uint32_t instep, uint32_t outstep);
    static void kernelU4(const RsForEachKernelStruct *p,
                         uint32_t xstart, uint32_t xend,
                         uint32_t instep, uint32_t outstep);
    static void kernelF1(const RsForEachKernelStruct *p,
                         uint32_t xstart, uint32_t xend,
                         uint32_t instep, uint32_t outstep);
    static void kernelF2(const RsForEachKernelStruct *p,
                         uint32_t xstart, uint32_t xend,
                         uint32_t instep, uint32_t outstep);
    static void kernelF4(const RsForEachKernelStruct *p,
                         uint32_t xstart, uint32_t xend,
                         uint32_t instep, uint32_t outstep);
};
...
static void ConvolveOneU4(const RsForEachKernelStruct *p, uint32_t x, uchar4 *out,
...
static void ConvolveOneU2(const RsForEachKernelStruct *p, uint32_t x, uchar2 *out,
...
static void ConvolveOneU1(const RsForEachKernelStruct *p, uint32_t x, uchar *out,
...
static void ConvolveOneF4(const RsForEachKernelStruct *p, uint32_t x, float4 *out,
...
static void ConvolveOneF2(const RsForEachKernelStruct *p, uint32_t x, float2 *out,
...
static void ConvolveOneF1(const RsForEachKernelStruct *p, uint32_t x, float *out,
...
void RsdCpuScriptIntrinsicConvolve3x3::kernelU4(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
...
void RsdCpuScriptIntrinsicConvolve3x3::kernelU2(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicConvolve3x3 *cp = (RsdCpuScriptIntrinsicConvolve3x3 *)p->usr;
...
void RsdCpuScriptIntrinsicConvolve3x3::kernelU1(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicConvolve3x3 *cp = (RsdCpuScriptIntrinsicConvolve3x3 *)p->usr;
...
void RsdCpuScriptIntrinsicConvolve3x3::kernelF4(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicConvolve3x3 *cp = (RsdCpuScriptIntrinsicConvolve3x3 *)p->usr;
...
void RsdCpuScriptIntrinsicConvolve3x3::kernelF2(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicConvolve3x3 *cp = (RsdCpuScriptIntrinsicConvolve3x3 *)p->usr;
...
void RsdCpuScriptIntrinsicConvolve3x3::kernelF1(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicConvolve3x3 *cp = (RsdCpuScriptIntrinsicConvolve3x3 *)p->usr;
