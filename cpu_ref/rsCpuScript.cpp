...
void RsdCpuScriptImpl::forEachMtlsSetup(const Allocation ** ains, uint32_t inLen,
    ...
    /*
     * FIXME:
     * I don't think we need to store the length because the expanded kernel
     * should know how many input arrays to expect.
     */
    //mtls->inLen      = inLen;
    ...
    if (ains) {
        ...
        for (int index = inLen; --index >= 0;) {
            // TODO: Add comment or macro to explain striding of ains.
            const Allocation *ain = ains[index * 2];
