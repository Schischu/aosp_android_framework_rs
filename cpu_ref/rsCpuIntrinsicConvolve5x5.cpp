...
static void OneU4(const RsForEachKernelStruct *p, uint32_t x, uchar4 *out,
...
static void OneU2(const RsForEachKernelStruct *p, uint32_t x, uchar2 *out,
...
static void OneU1(const RsForEachKernelStruct *p, uint32_t x, uchar *out,
...
static void OneF4(const RsForEachKernelStruct *p, uint32_t x, float4 *out,
...
static void OneF2(const RsForEachKernelStruct *p, uint32_t x, float2 *out,
...
static void OneF1(const RsForEachKernelStruct *p, uint32_t x, float *out,
...
void RsdCpuScriptIntrinsicConvolve5x5::kernelU4(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
...
void RsdCpuScriptIntrinsicConvolve5x5::kernelU2(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicConvolve5x5 *cp = (RsdCpuScriptIntrinsicConvolve5x5 *)p->usr;
    if (!cp->alloc.get()) {
...
void RsdCpuScriptIntrinsicConvolve5x5::kernelU1(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicConvolve5x5 *cp = (RsdCpuScriptIntrinsicConvolve5x5 *)p->usr;
    if (!cp->alloc.get()) {
...
void RsdCpuScriptIntrinsicConvolve5x5::kernelF4(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicConvolve5x5 *cp = (RsdCpuScriptIntrinsicConvolve5x5 *)p->usr;
    if (!cp->alloc.get()) {
...
void RsdCpuScriptIntrinsicConvolve5x5::kernelF2(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicConvolve5x5 *cp = (RsdCpuScriptIntrinsicConvolve5x5 *)p->usr;
    if (!cp->alloc.get()) {
...
void RsdCpuScriptIntrinsicConvolve5x5::kernelF1(const RsForEachKernelStruct *p,
                                                uint32_t xstart, uint32_t xend,
                                                uint32_t instep, uint32_t outstep) {
    RsdCpuScriptIntrinsicConvolve5x5 *cp = (RsdCpuScriptIntrinsicConvolve5x5 *)p->usr;
    if (!cp->alloc.get()) {
