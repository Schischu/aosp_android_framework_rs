...
protected:
    ...
    static void kernel(const RsForEachKernelStruct *p,
...
static void One(const RsForEachKernelStruct *p, void *out,
...
void RsdCpuScriptIntrinsicColorMatrix::kernel(const RsForEachKernelStruct *p,
                                              uint32_t xstart, uint32_t xend,
                                              uint32_t instep, uint32_t outstep) {
