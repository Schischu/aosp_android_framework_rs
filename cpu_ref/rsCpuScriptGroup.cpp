...
typedef void (*ScriptGroupRootFunc_t)(const RsForEachKernelStruct *kparams,
                                      uint32_t xstart, uint32_t xend,
                                      uint32_t instep, uint32_t outstep);

void CpuScriptGroupImpl::scriptGroupRoot(const RsForEachKernelStruct *kparams,
                                         uint32_t xstart, uint32_t xend,
                                         uint32_t instep, uint32_t outstep) {


    const ScriptList      *sl       = (const ScriptList *)kparams->usr;
    RsForEachKernelStruct *mkparams = (RsForEachKernelStruct *)kparams;
