...
class TestReadLocal(TestBase):
    ...
    def test_case(self):
        ...
        self.try_command('breakpoint set --file simple.rs --line 123', [])
        ...
        self.try_inspecting_local('char_local', ['(signed char)', '\'a\''])

        self.try_inspecting_local('uchar_local', ['(uchar)', '\'b\''])
