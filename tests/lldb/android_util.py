...
class AndroidUtil(object):
    ...
    def validate_adb(self):
        ...
        Returns:
            True if adb was successfully validated, False if not.
        '''
    ...
    def launch_elf(self, binary_name, args, env):
        ...
        for (key, value) in env:
            export_statements.append('export %s ="%s";' %(key, value))
    ...
    def launch_lldbserver(self, port):
        ...
        opts = '-l data/lldblog.txt -c ' + ';'.join(channels)
