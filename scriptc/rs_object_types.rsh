...
typedef enum {
    ...
    RS_ALLOCATION_USAGE_SHARED = 0x0080 // Allocation's backing store is inherited from another object (usually a Bitmap).  Copying to or from the original source Bitmap will cause a synchronization rather than a full copy.
