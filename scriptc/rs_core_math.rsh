 ...
 * Supported by API versions 21 and newer.
 */
extern float __attribute__((const, overloadable))native_distance(float);
#endif
 ...
 * Supported by API versions 21 and newer.
 */
extern float2 __attribute__((const, overloadable))native_distance(float2);
#endif
 ...
 * Supported by API versions 21 and newer.
 */
extern float3 __attribute__((const, overloadable))native_distance(float3);
#endif
 ...
 * Supported by API versions 21 and newer.
 */
extern float4 __attribute__((const, overloadable))native_distance(float4);
#endif
