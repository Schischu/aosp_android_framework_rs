 ...
 * Supported by API versions 21 and newer.
 */
extern float __attribute__((const, overloadable))native_divide(float lhs, float rhs, float lhs, float rhs);
#endif
 ...
 * Supported by API versions 21 and newer.
 */
extern float2 __attribute__((const, overloadable))native_divide(float2 lhs, float2 rhs, float2 lhs, float2 rhs);
#endif
 ...
 * Supported by API versions 21 and newer.
 */
extern float3 __attribute__((const, overloadable))native_divide(float3 lhs, float3 rhs, float3 lhs, float3 rhs);
#endif
 ...
 * Supported by API versions 21 and newer.
 */
extern float4 __attribute__((const, overloadable))native_divide(float4 lhs, float4 rhs, float4 lhs, float4 rhs);
#endif
