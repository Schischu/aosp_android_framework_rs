...
public:
    ...
    virtual void serialize(Context *rsc, OStream *stream) const override;
    virtual RsA3DClassID getClassId() const override;
    virtual bool freeChildren() override;
    ...
    virtual void Invoke(Context *rsc, uint32_t slot, const void *data, size_t len) override;
    virtual void setupScript(Context *rsc) override;
    virtual uint32_t run(Context *) override;
    virtual bool isIntrinsic() const override { return true; }
protected:
