...
public class UT_sg2_pointwise extends UnitTest {
    ...
    protected UT_sg2_pointwise(RSTestCore rstc, Resources res, Context ctx) {
        super(rstc, TAG, ctx);
        mRes = res;
    }
    ...
    public void run() {
        ...
        ScriptGroup2.Closure c1 =
                builder.addKernel(s_double.getKernelID_doubble(),
                                  Type.createX(pRS, Element.I32_4(pRS), ARRAY_SIZE),
