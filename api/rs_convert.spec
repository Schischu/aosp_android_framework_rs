...
description:
 Packs three or four floating point RGBA values into a uchar4.  The RGBA values are
...
description:
 Unpacks a uchar4 color to float4.  The resulting floats will be between 0.0 and 1.0.
test: none
end:
