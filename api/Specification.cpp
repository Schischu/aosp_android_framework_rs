...
string FunctionSpecification::expandString(string s, int i1, int i2, int i3, int i4) const {
...
void FunctionSpecification::expandStringVector(const vector<string>& in, int i1, int i2, int i3,
                                               int i4, vector<string>* out) const {
    out->clear();
