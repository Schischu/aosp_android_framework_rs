...
void SpecFile::addConstantSpecification(ConstantSpecification* spec, bool documented) {
...
void SpecFile::addTypeSpecification(TypeSpecification* spec, bool documented) {
...
void SpecFile::addFunctionSpecification(FunctionSpecification* spec, bool documented) {
