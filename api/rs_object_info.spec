...
summary: Type information of a cell of an allocation
description:
 Get the element object describing the type information of a cell of an allocation.
 See the rsElement* functions below.
test: none
end:
