...
private:
    ...
    std::string expandString(std::string s, int i1, int i2, int i3, int i4) const;
    void expandStringVector(const std::vector<std::string>& in, int i1, int i2, int i3, int i4,
