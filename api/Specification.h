...
private:
     ...
     * same for 2, 3, and 4.
     */
    std::string expandString(std::string s, int indexOfReplaceable1, int indexOfReplaceable2,
                             int indexOfReplaceable3, int indexOfReplaceable4) const;
    void expandStringVector(const std::vector<std::string>& in, int indexOfReplaceable1,
                            int indexOfReplaceable2, int indexOfReplaceable3,
                            int indexOfReplaceable4, std::vector<std::string>* out) const;
...
public:
    ...
    std::string getName(int i1, int i2, int i3, int i4) const;
    void getReturn(int i1, int i2, int i3, int i4, std::string* retType, int* lineNumber) const;
    size_t getNumberOfParams() const { return mParameters.size(); }
    void getParam(size_t index, int i1, int i2, int i3, int i4, std::string* type,
                  std::string* name, std::string* testOption, int* lineNumber) const;
    void getInlines(int i1, int i2, int i3, int i4, std::vector<std::string>* inlines) const;
...
public:
    FunctionPermutation(Function* function, FunctionSpecification* specification, int i1, int i2,
                        int i3, int i4, Scanner* scanner);
    ~FunctionPermutation();
