...
public:
    ...
    /* These are called the parser to keep track of the specifications defined in this file.
     * documented is true if the corresponding definition is first documented in this file.
     */
    void addConstantSpecification(ConstantSpecification* spec, bool documented);
    void addTypeSpecification(TypeSpecification* spec, bool documented);
    void addFunctionSpecification(FunctionSpecification* spec, bool documented);
};
