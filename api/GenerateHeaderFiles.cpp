...
/* Write #ifdef's that ensure that the specified version is present.  If we're at the final
 * the final version, add a check on flag that can be set for internal builds.  This enables
 * us to keep supporting old APIs in the runtime code.
 */
