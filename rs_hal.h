...
enum RsHalInitEnums {
    RS_HAL_CORE_INIT                                        = 1,
    RS_HAL_CORE_SHUTDOWN                                    = 2,
    RS_HAL_CORE_GET_DRIVER_VERSION                          = 3,
    RS_HAL_CORE_SET_PRIORITY                                = 4,
    RS_HAL_CORE_ALLOC_RUNTIME_MEM                           = 5,
    RS_HAL_CORE_FREE_RUNTIME_MEM                            = 6,
    RS_HAL_CORE_FINISH                                      = 7,
    ...
    RS_HAL_GRAPHICS_MESH_SET_ACTIVE                         = 104001,
    RS_HAL_GRAPHICS_MESH_DESTROY                            = 104002,
    RS_HAL_GRAPHICS_PATH_INIT                               = 105000,
    RS_HAL_GRAPHICS_PATH_SET_ACTIVE                         = 105001,
    RS_HAL_GRAPHICS_PATH_DESTROY                            = 105002,
    RS_HAL_GRAPHICS_FB_INIT                                 = 106000,
    RS_HAL_GRAPHICS_FB_SET_ACTIVE                           = 106001,
    RS_HAL_GRAPHICS_FB_DESTROY                              = 106002,
    RS_HAL_GRAPHICS_STORE_INIT                              = 107000,
    RS_HAL_GRAPHICS_STORE_SET_ACTIVE                        = 107001,
    RS_HAL_GRAPHICS_STORE_DESTROY                           = 107002,
};
 ...
 * success
 */
bool rsdHalQueryHAL(RsHalInitEnums entry, void **fnPtr);
