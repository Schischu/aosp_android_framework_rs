...
//////////////////////////////////////////////////////////////////////////////
#ifdef __i386__
// i386 has different struct return
...
void __attribute__((overloadable)) rsForEach(::rs_script script,
    ...
    Context *rsc = RsdCpuReference::getTlsContext();
    rsrForEach(rsc, (Script *)script.p, (Allocation *)in.p, (Allocation *)out.p, usr, 0, (RsScriptCall*)call);
}
...
void __attribute__((overloadable)) rsForEach(::rs_script script,
                                             ...
                                             const void *usr) {
    Context *rsc = RsdCpuReference::getTlsContext();
    rsrForEach(rsc, (Script *)script.p, (Allocation *)in.p, (Allocation *)out.p, usr, 0, nullptr);
}
...
void __attribute__((overloadable)) rsForEach(::rs_script script,
                                             ...
                                             ::rs_allocation out) {
    Context *rsc = RsdCpuReference::getTlsContext();
    rsrForEach(rsc, (Script *)script.p, (Allocation *)in.p, (Allocation *)out.p, nullptr, 0, nullptr);
}
...
void __attribute__((overloadable)) rsForEach(::rs_script script,
                                             ...
                                             uint32_t usrLen) {
    Context *rsc = RsdCpuReference::getTlsContext();
    rsrForEach(rsc, (Script *)script.p, (Allocation *)in.p, (Allocation *)out.p, usr, usrLen, nullptr);
}
...
void __attribute__((overloadable)) rsForEach(::rs_script script,
                                             ...
                                             const rs_script_call *call) {
    Context *rsc = RsdCpuReference::getTlsContext();
    rsrForEach(rsc, (Script *)script.p, (Allocation *)in.p, (Allocation *)out.p, usr, usrLen, (RsScriptCall*)call);
}
#endif
