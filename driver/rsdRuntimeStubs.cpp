...
static inline Allocation* rsGetObjPtr(RS_TY_ALLOC a) { return const_cast<Allocation*>(a.p); }
#ifndef RS_COMPATIBILITY_LIB
static inline Script* rsGetObjPtr(RS_TY_SCRIPT s) { return const_cast<Script*>(s.p); }
#endif
#else
typedef android::renderscript::rs_script*     RS_TY_SCRIPT;
typedef android::renderscript::rs_allocation* RS_TY_ALLOC;
