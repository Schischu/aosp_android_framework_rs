...
// message.
static void failIfInKernel(Context *rsc, const char *funcName) {
...
static void SC_AllocationCopy1DRange(RS_TY_ALLOC dstAlloc,
    ...
    Context *rsc = RsdCpuReference::getTlsContext();
    failIfInKernel(rsc, "rsAllocationCopy1DRange");
...
static void SC_AllocationCopy2DRange(RS_TY_ALLOC dstAlloc,
    ...
    Context *rsc = RsdCpuReference::getTlsContext();
    failIfInKernel(rsc, "rsAllocationCopy2DRange");
...
static void SC_AllocationIoSend(RS_TY_ALLOC alloc) {
    Context *rsc = RsdCpuReference::getTlsContext();
    failIfInKernel(rsc, "rsAllocationIoSend");
...
static void SC_AllocationIoReceive(RS_TY_ALLOC alloc) {
    Context *rsc = RsdCpuReference::getTlsContext();
    failIfInKernel(rsc, "rsAllocationIoReceive");
