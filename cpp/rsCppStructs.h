 ...
 */
 ...
 public:
     ...
     */
    bool init(const char * name, uint32_t nameLen, uint32_t flags = 0);
 ...
 private:
    ...
    bool init(const char * name, uint32_t nameLen, int targetApi, uint32_t flags);
...
public:
    ...
    private:
        ...
        sp<Element> * mElements;
        char ** mElementNames;
        uint32_t * mElementNameLens;
    ...
    public:
        Builder(sp<RS> rs);
        ~Builder();
        void add(sp<Element> e, const char * name, uint32_t nameLen, uint32_t arraySize = 1);
