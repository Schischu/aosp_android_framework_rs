...
public:
    ...
    size_t getSubElementCount() {
        return mVisibleElementMapSize; //mVisibleElementMap.size();
    }
    ...
    private:
        ...
        //size_t* mElementNamesLen;
        const char ** mElementNames;
    ...
    public:
        Builder(sp<RS> rs);
        ~Builder();
        void add(sp<Element> e, const char * name, uint32_t arraySize = 1);
