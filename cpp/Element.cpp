...
Element::Builder::Builder(android::RSC::sp<RS> rs) {
    ...
    mElementNameLengths = (uint32_t*)calloc(mElementsVecSize, sizeof(uint32_t));
...
void Element::Builder::add(android::RSC::sp<const Element>e, const char * name, size_t nameLen, uint32_t arraySize) {
    ...
    mElementNameLengths[mElementsCount] = nameLen;
    mElementNames[mElementsCount] = (char *)calloc(nameLen, sizeof(char));
