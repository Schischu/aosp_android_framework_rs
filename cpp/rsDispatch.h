...
typedef void (*Allocation2DElementDataFnPtr) (RsContext, RsAllocation, uint32_t, uint32_t, uint32_t, const void*, size_t, size_t);
...
typedef void (*Allocation1DElementReadFnPtr) (RsContext, RsAllocation, uint32_t, uint32_t, void*, size_t, size_t);
typedef void (*Allocation2DElementReadFnPtr) (RsContext, RsAllocation, uint32_t, uint32_t, uint32_t, void*, size_t, size_t);
...
struct dispatchTable {
    ...
    Allocation2DElementDataFnPtr Allocation2DElementData;
    ...
    Allocation1DElementReadFnPtr Allocation1DElementRead;
    Allocation2DElementReadFnPtr Allocation2DElementRead;
